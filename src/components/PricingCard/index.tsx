...
const PricingCard = ({ price }) => {
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="flex space-x-3">
            <AiFillCheckCircle
              ...
              aria-hidden="true"
            />
            <h2 className="text-sm text-gray-500">Receive responsive support for any inquiries.</h2>
          </div>
          <div className="border" />
          <div className="flex space-x-3">
            <AiFillCheckCircle
              ...
              aria-hidden="true"
            />
            <h2 className="text-sm text-gray-500">Benefit from continuous software improvements.</h2>
          </div>
          <div className="border" />
          <div className="flex space-x-3">
            <AiFillCheckCircle
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="flex space-x-3">
            <AiFillCheckCircle
              ...
              aria-hidden="true"
            />
            <p className="text-sm text-gray-500">Stay up-to-date with the latest enhancements.</p>
          </div>
          <div className="border" />
          <div className="flex space-x-3">
            <AiFillCheckCircle
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="flex space-x-3">
            <AiFillCheckCircle
              ...
              aria-hidden="true"
            />
            <p className="text-sm text-gray-500">Receive regular updates and new feature releases.</p>
          </div>
          <div className="border" />
          <div className="flex space-x-3">
            <AiFillCheckCircle
  ...
  return (
    <div className="border-gray-100 shadow-2xl border-4 text-center mt-10 max-w-[1040px]">
      <Toaster position="top-center" /> {/* Initialize react-hot-toast Toaster */}
      <div>
        ...
        <div>
          <div className="flex flex-col items-center justify-center pt-4">
            <h1 className="text-5xl font-bold">{(price.unit_amount / 100).toLocaleString('en-US', {
              style: 'currency',
              currency: 'USD'
            })}</h1>
          </div>
