...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Intellara's intelligent chatbot is your 24/7 project assistant, ready to answer questions, provide updates, and streamline communication. With its intuitive interface and quick responses, the chatbot enhances collaboration and accelerates decision-making, ensuring your team stays connected and productive at all times."
    },
  {
    id: 1,
    icon: (
    ...
    title: "Expert Team",
    paragraph:
      "Access a dedicated team of industry experts within Intellara, offering invaluable insights, guidance, and support to optimize your projects's success. Whether you need strategic advice or expertise, our experienced teams are here to help you overcome challenges.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Encompasses the automation of repetitive and manual tasks within the project management lifecycle. Intellara streamlines and automate the repetitive tasks and processes, reducing manual intervention and improving efficiency.",
  },
];
