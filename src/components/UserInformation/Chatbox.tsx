...
class Chatbox {
    ...
    updateChatText(chatbox: HTMLElement | null) {
        ...
        this.messages.forEach(function (item) {
            if (item.name === 'Sam') {
                html += '<div class="messages__item messages__item--visitor bg-gray-300 text-black rounded-lg p-2 m-1 w-fit max-w-[70%] break-words">' + item.message + '</div>';
            } else {
                html += '<div class="messages__item messages__item--operator bg-purple-600 text-white rounded-lg p-2 m-1 w-fit max-w-[70%] ml-auto break-words">' + item.message + '</div>';
            }
        });
        ...
        <div className="container">
            <div className="absolute bottom-8 right-8">
                <div className="transform transition-all duration-500 ease-in-out bg-gray-200 w-80 h-[450px] z-[-123456] opacity-0 chatbox__support flex flex-col">
                    <div className="sticky top-0 bg-gradient-to-r from-purple-500 to-purple-700 flex items-center justify-center p-4 rounded-t-2xl shadow-lg">
                        <div className="mr-2">
                    ...
                    <div className="sticky bottom-0 bg-gradient-to-r from-purple-500 to-purple-700 flex items-center justify-between p-4 shadow-lg rounded-b-xl chatbox__footer">
